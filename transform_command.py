...
def transform_image_command(image_path,double=False,frames=10, cleanup=True, make_mov=False,just_see=True,invert=False,filter=2,\
    ...
    if just_see:
        ...
        add_effects.pyvista_command(new_file,"./images/imageToSave.jpeg", background_image)
    else:
        if double:
...
if __name__ == "__main__":
    ...
    transform_image_command(image_path,frames=48,cleanup=True,make_mov=True,double=True,\
    filter=2,invert=False,just_see=False,background_image=background_image)